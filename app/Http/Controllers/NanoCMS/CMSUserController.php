...
class CMSUserController extends \NanoCMS\Http\Controllers\Controller {
    ...
    public function index() {
        ...
        return view("admin.usuarios.index", $this->retorno);
    }
    ...
    public function create() {
        ...
        return view("admin.usuarios.inserir", $this->retorno);
    }
    ...
    public function store() {
        ...
        if ($this->request['password'] !== $this->request['password_confirmation'] || $this->request['password'] == '') {
            ...
            return view('admin.usuarios.inserir')->with($this->retorno);
        }
        ...
        if ($validator->fails()) {
            ...
            if ($usuario->save()) {
                ...
                return redirect()->route('admin.usuarios.index')->with($this->retorno);
            }
    ...
    public function update($id) {
        ...
        if ($this->request['password'] !== $this->request['password_confirmation'] || $this->request['password'] == '') {
            ...
            $this->retorno['request'] = $this->request;
            return view('admin.usuarios.editar')->with($this->retorno);
        }
